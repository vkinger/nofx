...
export const translations = {
  en: {
    ...
    showOnlyValidActions: 'Show only valid actions',
    validDecisions: 'valid',
    noValidDecisions: 'No Valid Decisions',
    noValidDecisionsHint: 'No open/close actions found in recent decisions',
    ...
    cotEmpty: 'No reasoning recorded.',
  ...
  zh: {
    ...
    showOnlyValidActions: '仅显示有效操作',
    validDecisions: '条有效',
    noValidDecisions: '无有效决策',
    noValidDecisionsHint: '最近决策中未找到开仓或平仓操作',
    filterBySymbol: '币种',
    allSymbols: '全部',
    cycle: '周期',
    success: '成功',
