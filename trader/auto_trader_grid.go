...
func (at *AutoTrader) InitializeGrid() error {
	...
	if gridConfig.UseATRBounds {
		...
		mktData, err := market.GetWithTimeframes(gridConfig.Symbol, at.exchange, []string{"4h"}, "4h", 20)
		if err != nil {
...
func (at *AutoTrader) buildGridContext() (*kernel.GridContext, error) {
	...
	// Get market data (use trader's exchange)
	mktData, err := market.GetWithTimeframes(gridConfig.Symbol, at.exchange, []string{"5m", "4h"}, "5m", 50)
	if err != nil {
